...
function logar(){
    ...
    if(pergunta1 === "Gabriella" && pergunta2 === "2022" && pergunta3 === "Casados" && pergunta4 === "Piquenique" && pergunta5 === "Escola" && pergunta6 === "Infinito"){
        document.querySelector('h1').textContent = 'Eu te amo muito';
        const painel = document.querySelector('.painel');
        const novoParagrafo = document.createElement('p');
        novoParagrafo.textContent = '"Para cada questão, insira um dígito da data em que nosso relacionamento começou."'; // texto do        parágrafo
    ...
    else if(pergunta1 === "1" && pergunta2 === "8" && pergunta3 === "0" && pergunta4 === "4" && pergunta5 === "2" && pergunta6 === "2"){
